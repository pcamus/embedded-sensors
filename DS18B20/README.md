...
<p>Python programming for the Raspberry Pi.</p>
<p><br />OneWire bus must be enabled with the configuration utility of Raspbia (interface tab).</p>
<p><br />Then add the following line in : /boot/config.txt<br />dtoverlay=w1-gpio,gpiopin=6</p>
<p><br />You can specify which line to use for the sensor (in the exemple : GPIO6), GPIO4 is the default</p>
